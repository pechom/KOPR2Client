...
public class SQLQueries {
	...
	public static final String COURSE_OF_ATTENDANCE = "SELECT prezencka.predmet_uuid from prezencka WHERE prezencka.auuid = ";
	
	public static final String TIME_OF_ATTENDANCE = "SELECT prezencka.cas from prezencka WHERE prezencka.auuid = ";
	
	public static final String NAME_OF_STUDENT = "SELECT ucastnik.meno FROM ucastnik WHERE ucastnik.uuuid = ";
	
	public static final String SURNAME_OF_STUDENT = "SELECT ucastnik.priezvisko FROM ucastnik WHERE ucastnik.uuuid = ";
	
	public static final String NAME_OF_COURSE = "SELECT predmet.nazov FROM predmet WHERE predmet.puuid = ";
